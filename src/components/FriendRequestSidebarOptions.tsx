...
export interface IFriendRequestSidebarOptions {
  ...
  return (
    ...
    >
      ...
      {unseenRequestCount > 0 ? (
        <div
          className="rounded-full w-5 h-5 text-sm flex justify-center items-center text-white bg-indigo-600"
        >
          {unseenRequestCount}
        </div>
      ) : null}
